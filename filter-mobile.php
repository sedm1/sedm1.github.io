...
<html lang="ru">
  ...
  <body>
    <!-- [if lt IE 8]>
    <div class="browserupgrade">Вы используете <strong>устаревшую</strong> версию браузера.Пожалуйста
		<a href="http://browsehappy.com/">обновите свой браузер</a>.</div>
    <![endif] -->
...
<!--					  <a class="return" href="--><?php //echo $_SERVER['HTTP_REFERER'];?><!--">назад</a>-->
					  <a class="return" href="#" onclick="window.history.back(); return false;" >назад</a>
                  </div>
                </div>
                <!--Блок поиск по категории-->
                <div class="block-filter"><span class="search-filter">Поиск по категории</span>
                </div>
                          ...
                          foreach($row_filter as $row) :?>
                            ...
                            if ($row['id'] == 39 || $row['id'] == 37  || $row['id'] == 24 || $row['id'] == 13 ){?>
                                ...
                                <a <?php
                                    ...
                                    <?php ;} ?> href="catalog-filter-mobile.php?subid=<?=$row['id'];?>">
