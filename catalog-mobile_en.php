...
//$pagination->url = 'catalog-mobile_en.php' . $url . '&page={page}';
      ...
      <section class="catalog">
                <div class="container">
                  ...
                  <div class="block-return"><img src="/mobile/img/icon/arrow_back.svg" alt="Back"/>
                      <a class="return" href="#" onclick="window.history.back(); return false;">back</a>
                  </div>
                </div>
          ...
          <?php if ( isset($_GET['status']) !=3){?>
                <div class="container">
                  <div class="block-filter">
                      <a class="search-filter" href="filter-mobile_en.php?<?php if(isset($_GET['catid'])){
                          echo 'catid='.$catid.'';
                      }elseif (isset($_GET['subid']) == 25) {
                          echo 'subid='.$subid.'';
                      }?> ">Search per Category</a>
                  </div>
                </div>
          <?php } ?>
          ...
          <div class="container">
                          ...
                          ?>
                              <li>
                                  <div <?php if ($row['status'] == 3) {
                                      ...
                                      <a href="product-mobile_en.php?catid=<?=$row['cat_id'];?>&item=<?= $row['id'] ?>">
                                          <div class="view">
                                              <div class="status
                                                <?php
                                                  if ($row['status'] == '0') {
                                                  ...
                                                  <?php if ($row['catalog_image']) {
                                                      echo '<img class="lazy" data-src="../../uploads/catalog/' . $row['catalog_image'] . '" alt="' . $row['description_en'] . '">';
                                                  } ?>
                                          </div>
              ...
              <div class="block-sticky">
                  ...
                  <div class="block-delivery">
                      <p class="delivery-title">FREE SHIPPING FROM € 100</p>
