...
<title>NB Outlet - <?php echo $item['name_en'] ?></title>
<meta name="description" content="<?=$item['meta_d_en'] ?>">
<meta name="keywords" content="<?=$item['meta_k_en'] ?>">
...
<div id="wrapper">
    ...
    <div id="product">
    	<div id="info">
            ...
            <div id="right-column">
            	<div id="title"><?php echo $item['name']; ?> (<?php echo $item['description_en']; ?>)
                ...
                <span id="description"><?php echo $item['text_en'] ?></span>
                <div style="top: 96px; position:relative;">
					...
					<div class="size-error">Choose size</div>
                    ...
                    <span id="order-button" <?php if ($item['status'] == '2') { echo "class=\"order-button-sold\""; }?>>
						<a <?php if ($item['status'] != '2') { ?> href="#ex1" rel="modal:open" <?php } ?>>Buy it Now</a>
						<?php if ($item['status'] != '2') : ?>
						  <a class="addToCart" href="javascript:void(0)" data-id="<?php echo $item_id; ?>"><?php echo $language[$lang]['addtocart'];?></a>
						<?php endif; ?>
					</span>
                </div>
                <div id="small-photo">
        ...
        <div id="item-list">
            ...
            <ul>
            	<?php
                $rand_product = mysql_query("SELECT `id`, `name`, `description_en`, `text`, `article`, `price`, `catalog_image`, `status`,`price_stock` FROM `catalog` WHERE status !='2' and `id` !='".$item_id."' and `cat_id` NOT IN (7,8,9,10,11,12) ORDER BY RAND() LIMIT 10");
                ...
                <li <?php if($offer['status'] == 3){ echo 'style="box-shadow: 0px 0 0px 3px red;"'; }?>>
                    <a href="view_en.php?item=<?=$offer['id'] ?>">
                        ...
                        <div class="description"><?=$offer['description_en'] ?></div>
        ...
        <div id="item-bottom">
        	<a href="catalog_en.php?catid=1"><div class="button1">Switch to Catalog</div></a>
            <a href="index_en.php"><div class="button1">To the main</div></a>
        </div>
    </div>
