...
class Pagination_mob_lv {
    ...
    public $text_next = '';
    public $text_prev = '';
    public $text_more = 'parādīt vairāk';
    ...
    public function render() {
        ...
        $output = '<div class="nav_block"><div class="navigation-link">';
...
//            }
        ...
        if ($page < $num_pages) {
            $output .= '<a href="' . str_replace('{page}', $page + 1, $this->url) . '" id="show_more">' . $this->text_more . '</a>';
