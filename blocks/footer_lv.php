  ...
  <div class="container">
        <div class="block-link">
            ...
            <div class="right-column">
                <div>Informācija</div>
                    <ul>
                        <li><a href="pdf/How To Find US (NB Outlet) LV.pdf" target="new">Kā mums atrast</a></li>
                        <li><a href="pdf/Payment and delivery LV.pdf" target="new">Apmaksa un Piegāde</a></li>
                    </ul>
            </div>
        </div>
        <div class="block-info" style="width: 620px;">
			...
			<div class="subscribe" id="subs">
				...
				<form id="subs-form" action="http://<?php echo $_SERVER['HTTP_HOST'] . '/send_email_lv.php';?>" method="POST">
        ...
        <div class="copyright"><img src="images/copyright.png" width="15" height="15" alt="copyright"> NB OUTLET 2016 Visas tiesibas aizsargatas </div>
    </div>
</div>
