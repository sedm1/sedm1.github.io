      ...
      <section class="product">
                <div class="container">
                  ...
                  <div class="block-return"><img src="/mobile/img/icon/arrow_back.svg" alt="Back"/>
                      <a href="#" class="return" onclick="window.history.back(); return false;" >back</a>
                  </div>
                </div>
                ...
                <div class="container">
                  <div class="product-item">
                    <div class="product-img">
                        ...
                        switch($item['status']){
                            case 0: $status = ''; break;
                            case 1: $status = '<span class="status status-prod new rotate"></span>'; break;
                            case 2: $status = '<span class="status status-prod sold rotate"></span>'; break;
//                              default: $status = '<span class="status offer rotate"></span>';
                    ...
                    <div class="product-content">
                      <div class="title"><?php echo $item['name_en']; ?> (<?php echo $item['description_en']; ?>)
                      </div>
                        <?php if ($item['status'] != '2') {
                        ?>
                        <?php if($item['status'] == 3){ ?>
                            <span class="price" id="price" style="float: left; margin: 0 10px 0 0;">&euro; <?=$item['price_stock'] ?></span>
                      ...
                      <div class="size">
						...
						<div class="description"><?php echo $item['text_en'] ?>
                      </div>
        ...
        <div class="container">
          <div class="block-buttons">
              ...
              <span id="order-button"
                  <?php if ($item['status'] == '2') { echo "class=\"order-button-sold\""; }?>>
                <a class="btn by_now" <?php if ($item['status'] != '2') { ?> href="#ex1" rel="modal:open" <?php } ?> >Buy it Now</a>
                  <?php if ($item['status'] != '2') : ?>
                        <!-- Кнопка В корзину-->
                  <button class="btn in_cart addToCart" href="javascript:void(0)" data-id="<?php echo $item_id; ?>"><?php echo $language[$lang]['addtocart'];?></button>
                  <?php endif; ?>
              </span>
          </div>
        </div>
