...
define( 'MAIL_ADR_FROM', 'mailer@easymisc.ru' );
//define( 'MAIL_ADR_FROM', 'zm3158589525lt@bpauto.lv' );
//define( 'MAIL_ADR_TO', '_support@bk.ru' );
...
//Письмо 
$to = $row['email'];
$subject = "NB Outlet (Рассылка) RUS";
...
$sender = "=?utf-8?B?".base64_encode('Site NBOutlet.eu')."?= <".MAIL_ADR_FROM.">";
