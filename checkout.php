...
<script type="text/javascript">
  ...
  <div id="wrapper">
	<div id="bg_layer"></div>
	<!--Шапка-->
	<?php include("blocks/header".$ext.".php"); ?>
  	<!--Товар-->
    <div id="checkout">
      <div class="container">
	    ...
	    <?php if(isset($_SESSION['cart'])) : ?>
		  <table class="table">
			...
			<tfoot>
			  <tr>
			    <td colspan="5" class="text-right"><span class="text-grey"><?php echo $language[$lang]['fooltotal'];?></span> <span class="total"><?php echo ($_SESSION['cart']['total']) ? $_SESSION['cart']['total']['sum']  : 0; ?></span></td>
			  </tr>
			</tfoot>
		  </table>
		  <a class="button-white" href="/index<?php echo $ext ?>.php"><?php echo $language[$lang]['continue'];?></a>
		  ...
		  <div class="order-form">
		    ...
		    <div class="box">
		      <form id="order-form" action="order.php" class="catalog" method="POST">
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr>
				    ...
				    <td>
				      ...
				      <select name="shiping" id="shiping" required="required">
		  ...
		  <?php include("blocks/randomproduct.php"); ?>
		<?php else : ?>
		<div class="text-center empty">
			<h2 class="text-center"><?php echo $language[$lang]['empty'];?></h2>
			<a class="button-white" href="/index<?php echo $ext ?>.php"><?php echo $language[$lang]['addproduct'];?></a>
		</div>
    ...
    <!--Подвал-->
    <?php include("blocks/footer".$ext.".php"); ?>
