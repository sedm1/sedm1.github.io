...
<!--				<a class="return" href="--><?php //echo $_SERVER['HTTP_REFERER'];?><!--">back</a>-->
				<a class="return" href="#" onclick="window.history.back(); return false;">back</a>
            </div>
        </div>
        <!--Блок поиск по категории-->
        <div class="block-filter"><span class="search-filter">SEARCH BY CATEGORY</span>
        </div>
                ...
                foreach($row_filter as $row) :?>
                    ...
                    if ($row['id'] == 39 || $row['id'] == 37  || $row['id'] == 24 || $row['id'] == 13 ){?>
                        ...
                        if ($row['id'] == 39 || $row['id'] == 37  || $row['id'] == 24 || $row['id'] == 13 ){?>
                            ...
                            <?php ;} ?> href="catalog-filter-mobile_en.php?subid=<?=$row['id'];?>">
                            <?php echo $row['subcategory_en'];?>
                        </a>
                    </li>
