	...
	<section class="product">
		<div class="container">
			...
			<div class="block-return"><img src="/mobile/img/icon/arrow_back.svg" alt="Back" />
				<a href="#" class="return" onclick="window.history.back(); return false;">назад</a>
			</div>
		</div>
...
//                              default: $status = '<span class="status offer rotate"></span>';
				...
				<div class="product-content">
					<div class="title"><?php echo $item['name']; ?> (<?php echo $item['description']; ?>)
					</div>
					...
					<div class="description"><?php echo $item['text'] ?>
					</div>
		...
		<div class="container">
			<div class="block-buttons">
                ...
                <a class="btn by_now" <?php if ($item['status'] != '2') { ?> href="#ex1" rel="modal:open" <?php } ?> >купить сразу</a>
                  <?php if ($item['status'] != '2') : ?>
					  <!-- Кнопка В корзину-->
					  <button type="submit" form="product_form" class="btn in_cart addToCart" href="javascript:void(0)" data-id="<?php echo $item_id; ?>">В корзину</button>
                  <?php endif; ?>
              </span>
			</div>
		</div>
