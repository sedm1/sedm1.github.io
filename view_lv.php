...
<meta name="description" content="<?=$item['meta_d_lv'] ?>">
<meta name="keywords" content="<?=$item['meta_k_lv'] ?>">
...
<div id="wrapper">
    ...
    <div id="product">
        	...
        	<div id="cat-nav">
                <ul>
					...
					while ($cat = mysql_fetch_assoc($category)) {
						...
						<a href="catalog_lv.php?subid=25"><?=$cat['category_lv'] ?></a>
						<?php }else{?>
						<a href="catalog_lv.php?catid=<?=$cat['id'] ?>" <?php if ($cat['id'] == $item['cat_id']) { echo 'id="active"'; } ?>><?=$cat['category_lv'] ?></a>
						<?php }?>
						</li>
                        <?php
					}
            ...
            <div id="right-column">
                ...
                <div style="top: 96px; position:relative;">
                    ...
                    <span id="order-button" <?php if ($item['status'] == '2') { echo "class=\"order-button-sold\""; }?>>
						<a <?php if ($item['status'] != '2') { ?> href="#ex1" rel="modal:open" <?php } ?>>Pirkt Uzreiz</a>
						<?php if ($item['status'] != '2') : ?>
        ...
        <div id="item-list">
            ...
            <ul>
            	<?php
                $rand_product = mysql_query("SELECT `id`, `name`, `description_lv`, `text`, `article`, `price`, `catalog_image`, `status`,`price_stock` FROM `catalog` WHERE status !='2' and `id` !='".$item_id."' and `cat_id` NOT IN (7,8,9,10,11,12) ORDER BY RAND() LIMIT 10");
                ...
                <li <?php if($offer['status'] == 3){ echo 'style="box-shadow: 0px 0 0px 3px red;"'; }?>>
                    <a href="view_lv.php?item=<?=$offer['id'] ?>">
                        ...
                        <div class="description"><?=$offer['description_lv'] ?></div>
        ...
        <div id="item-bottom">
        	<a href="catalog.php?catid=1"><div class="button1">Pāriet uz Katalogu</div></a>
            <a href="index.php"><div class="button1">Uz galveno</div></a>
        </div>
    </div>
