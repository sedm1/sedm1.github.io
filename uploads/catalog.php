...
$pagination->url = 'catalog.php' . $url . '&page={page}';
...
<head>
	...
	<link rel="preload" as="font" crossorigin="crossorigin" type="" href="fonts/Circe-Light.woff">
	<link rel="preload" as="font" crossorigin="crossorigin" type="" href="fonts/Circe-Bold.woff">
	<link rel="preload" as="font" crossorigin="crossorigin" type="" href="fonts/Circe-Regular.woff">


	<link rel="preload" href="js/jquery-1.12.0.min.js" as="script">
	<script type="text/javascript" src="js/jquery-1.12.0.min.js"></script>

	<!-- <link rel="preload" href="js/jquery.lazyload.min.js" as="script"> -->
	<script async type="text/javascript" src="js/jquery.lazyload.min.js"></script>

	<!-- <link rel="preload" href="js/jquery.uniform.min.js" as="script"> -->
	<script async type="text/javascript" src="js/jquery.uniform.min.js"></script>

	<!-- <link rel="preload" href="fonts/circe-light.cufonfonts.js" as="script"> -->
	...
	<!-- <link rel="preload" href="fonts/circe.cufonfonts.js" as="script"> -->
	<script async type="text/javascript" src="fonts/circe.cufonfonts.min.js"></script>

	<!-- <link rel="preload" href="fonts/circe-bold.cufonfonts.js" as="script"> -->
	...
	<link rel="stylesheet" href="fonts/roboto-regular-webfont">

	<!-- <link rel="preload" href="fonts/roboto-bold-webfont.woff2" as="font"> -->
	<link rel="stylesheet" href="fonts/roboto-bold-webfont">
						...
						foreach ($arr2 as $cat) {
							...
							<li <?php if ($cat['id'] == $_SESSION['catid']) : ?> class="expand" <?php endif; ?>>
								<?php if (isset($cat['id']) && $cat['id'] == 3) { ?>
									<a href="?subid=25"><?= $cat['category'] ?></a>
								<?php } else { ?>
								...
								?>
									<?php if (isset($cat['id']) && $cat['id'] != 3) { ?>
										<li class="all-products-link"><a href="?catid=<?= $cat['id'] ?>">ВСЕ ТОВАРЫ</a></li>
									<?php } ?>
								</ul>
							</li>
