...
//if ($page != 1) $pervpage = '<a href="search-mobile_lv.php?q=' . $query . '&page=-1">Pirmajā</a>
//			<div class="nav_arrow_left"><a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page - 1) . '"></a></div> ';
//
//if ($page != $total) $nextpage = '  <div class="nav_arrow_right"><a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page + 1) . '"></a></div>
//			<a href="search-mobile_lv.php?q=' . $query . '&page=' . $total . '">Pēdējā</a> ';
//
//if ($page - 2 > 0) $page2left = ' <a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page - 2) . '">' . ($page - 2) . '</a>  ';
//if ($page - 1 > 0) $page1left = '<a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page - 1) . '">' . ($page - 1) . '</a>  ';
//if ($page + 2 <= $total) $page2right = '  <a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page + 2) . '">' . ($page + 2) . '</a>';
//if ($page + 1 <= $total) $page1right = '  <a href="search-mobile_lv.php?q=' . $query . '&page=' . ($page + 1) . '">' . ($page + 1) . '</a>';
...
<div class="catalog">
	<div class="container">
		...
		<div class="block-return"><img src="/mobile/img/icon/arrow_back.svg" alt="Back" />
			<a class="return" href="#" onclick="window.history.go(-1); return false;">atpakaļ</a>
		</div>
	</div>
	<!--//Блок Назад-->
	<div class="container">
		...
		<div class="search-result-text">
			...
			<p class="products-result">atrastas <?php echo $posts; ?> preces </p>
		</div>
